...
sliderInput('mu', 'common mu', 18,
              min = 1, max = 25,step=.5,ticks=F)

sliderInput('alpha_a', 'Alpha for red curve', value = c(.1),
              min = 0, max = 5 ,step=0.01, ticks=F)

sliderInput('alpha_b', 'Alpha for dark blue curve', value = c(0.01),
              min = 0, max = 5 ,step=0.01, ticks=F)

sliderInput('alpha_d', 'Alpha for purple curve', value = c(1),
              min = 0, max = 5 ,step=0.01, ticks=F)
...
apois = paste("Poisson mu=",mu,sep="")
anegbinom_a = paste("Neg Binom mu=",mu," alpha=",alpha_a,sep="")
anegbinom_b = paste("Neg Binom mu=",mu," alpha=",alpha_b,sep="")
anegbinom_c = paste("Normal mu=",mu," sd=sqrt(",mu,")",sep="")
anegbinom_d = paste("Neg Binom mu=",mu," alpha=",alpha_d,sep="")
