...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  b <- barplot(yb, xlim=c(0,xmax+2), ylab = "Percent", xlab="x", col='red',
          ylim=c(0,ymax),
          main =  paste("Negative Binomial \u03BC=",mu," \u03B1=",alpha_a,", based on common mean and red curve \u03B1,  variance =", mu+mu^2* alpha_a,""),
          names.arg= as.character(xx))
...
### **We use canned formulae for sample size and allow comparison. The formulae don't account for follow up nor treatment discontinuation, so simulation is preferable. They are useful however as a simulation sanity check and to ensure you are not confusing k and alpha.**
