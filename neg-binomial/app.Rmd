...
Show the equivalence of gamma Poisson and negative binomial (rnbinom) parmeterisations !  
...
br()
br()
HTML(" <strong>In short, either the parameter k or its reciprocal alpha is referred to as the 'dispersion parameter', 'shape parameter' or 'clustering coefficient', or the 'heterogeneity' or 'aggregation' parameter.  </strong>")

# HTML(" <strong>The term 'aggregation' is particularly used in ecology when describing counts of individual organisms. Decrease of the aggregation parameter k towards zero corresponds to increasing aggregation of the organisms; increase of r towards infinity corresponds to absence of aggregation, as can be described by Poisson regression.</strong>")
br()
br()
