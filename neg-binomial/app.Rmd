...
# par(mfrow=c(1,1))
  ...
  barplot(data_perc, ylab = "Percent", main =paste0("Treated true mu=",mu1," & k=",k," \nso alpha=",round(1/k,2),""), ylim=c(0,upp ))     
  data_perc <- t(prop.table(table(pla))) * 100    # Convert data to probability table
  barplot(data_perc, ylab = "Percent", main =paste0("Placebo true mu=",mu0," & k=",k," \nso alpha=",round(1/k,2),""), ylim=c(0,upp ))         
  par(mfrow=c(1,1))
