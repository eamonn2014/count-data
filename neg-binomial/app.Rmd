...
It is important to be sure whether the dispersion parameter is quoted in terms of alpha or k. The Wikipedia page 

To quote wikipedia 'The variance can then be written as {\textstyle m+{\frac {m^{2}}{r}}}{\textstyle m+{\frac {m^{2}}{r}}}. Some authors prefer to set {\textstyle \alpha ={\frac {1}{r}}}{\textstyle \alpha ={\frac {1}{r}}}, and express the variance as {\textstyle m+\alpha m^{2}}{\textstyle m+\alpha m^{2}}. 

```{r}
 
HTML(" <strong>To quote dirctly from Wikipedia 'The variance can then be written as .</strong>")
