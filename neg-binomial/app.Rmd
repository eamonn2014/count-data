...
$\alpha$ takes on positive rational values, rarely above 4 (Hilbe page 190). Values of alpha greater than 2 usually indicate that there is substantial over-dispersion or correlation in the Poisson data.

When  $\alpha$ approaches 0, k is infinite and Poisson emerges (move red $\alpha$ slider to 0).

When  $\alpha$ > 1, k < 1 leads to over dispersed data ($\alpha$ big).
