...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  gp  <-  rnbinom(n,  prob=  1/(1 + mu*length* alpha),  size=1/alpha)
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  A  <-   MASS::rnegbin(n, mu=mu,  theta=1/alpha)
  A1 <-   rnbinom(n=n,     mu=mu,  size= 1/alpha)
  B  <-   rpois(n , lambda=  mu * rgamma(n=n, shape = 1/alpha, scale = alpha))  
  B1 <-   rpois(n,  lambda= (mu * rgamma(n=n, shape = 1/alpha))*(alpha))  

#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# examine
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

  summary(A) ; summary(A1) ; summary(B) ; summary(B1)
  var(A);var(A1);var(B);var(B1)
