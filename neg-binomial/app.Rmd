...
Plot 3  If the Poisson distribution fits the data, the plot should show a straight line

Plot 4  If the Negative binomial distribution fits the data, the plot should show a straight line

Plot 5 shows default diagnostic plots for the negative-binomial model fit

The final  tab uses a more robust and useful version of these QQ plots: half normal plots, with simulated confidence envelopes. The essential ideas are:
