...
# Normal withen variance equal to mean also
##################################################################################
...
```{r}
 ...
 renderPrint({
  ...
  cat(paste0("\nEstimated placebo rate ",round(exp(f$coef[1]),4)," and multiplicative treatement effect estimate of ",round(exp(f$coef[2]),4),""))
