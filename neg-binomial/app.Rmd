...
```{r global, include=FALSE}
  ...
  #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    roundUpNice <- function(x, nice=c(1,1.5, 2,4,5,6,8,10)) { #added 1.5 to help barplot y scale
...
```{r}
  ...
  checkboxInput('perc','show stats on barplot')
...
# but then enter 1/.8 = ~1.3 so this is k
    ...
    checkboxInput('perc1','show stats on barplot')
