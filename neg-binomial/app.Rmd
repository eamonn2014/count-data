...
sliderInput('y_range', 'Plot y-range', value = c(0,.45),
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  barplot(yb, xlim=c(0,high+2), ylab = "Percent", xlab="x", col='black',
          ylim=c(0,ymax),
          main =  paste("Neg Binom \u03BC=",mu," \u03B1=",alpha_a,sep=""),
          names.arg= as.character(xx))
