...
```{r global, include=FALSE}
  ...
  #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    roundUpNice <- function(x, nice=c(1,1.5, 2,4,5,6,8,10)) {
...
```{r}
 ...
 # summary(MASS::glm.nb(y~dose+offset((logleng)), data=d))
  ...
  data_perc <- t(prop.table(table(x))) * 100    # Convert data to probability table
 ...
 # count plot
  ...
  # 
  barplot(table(factor(trt, levels=0:max(y)))  , main ="Treated counts" , col='blue',   ylim=c(0,u ))
  barplot(table(factor(pla, levels=0:max(y)))  , main ="Placebo counts" , col='green',  ylim=c(0,u ))
