...
# Q0.=.5 # Q0 = N0/N and Q1 = =N1/N
      ...
      sliderInput('p.prop.can', 'Placebo proportion N0/N1', value=.50,
...
```{r, eval=TRUE}
 ...
 #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  B <- 2 * round(B/2) # need even number in each group for my sim functions
   ...
   cat(paste0("Total sample size based on the user inputs and a function using equation 8 from 'Sample size calculations for skewed distributions' gives ",B," total patients required (rounded up to an even number)\n"))
...
```{r}
    ...
    tags$a(href = "https://bmcmedresmethodol.biomedcentral.com/track/pdf/10.1186/s12874-015-0023-0.pdf",target="_blank", tags$span(style="color:blue", "[13] Sample size calculations for skewed distributions"),) 
        div(p(" "))
      tags$a("xxx", href = "https://bmcmedresmethodol.biomedcentral.com/track/pdf/10.1186/s12g874-015-0023-0.pdf", target="_blank",
           tags$span(style="color:blue", "'Sample size calculations for skewed distributions' (equation 8) used in function 1"),) 
